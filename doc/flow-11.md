# OKD - Flow 11 Aanmelden ondersteunende documenten bij de inschrijving in DMS
...
Als er documenten met betrekking op de inschrijving van een student in het DMS gecreerd of opgeslage worden die niet afkomstig zijn van de MORA inschrijfmodule dan kan het DMS deze documenten aanmelden bij de module zodat deze getoond en opgevraagd kunnen worden. De inhoud van het document word niet uitgewisseld. 
...
sequenceDiagram
    ...
    DMS->>+Inschrijven: POST .../okd/v1/documents/_registerdmsdocument (meta informatie)
